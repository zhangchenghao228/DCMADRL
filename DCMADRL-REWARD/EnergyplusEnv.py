...
class EnergyPlusEnvironment:
    def __init__(self) -> None:
        ...
        self.swanlab = swanlab.init(
            project="MASAC_IPO",
            workspace="ZCH_SDU",
            experiment_name = "MASAC_IPO_Distribution_reward_cost_2",  # 添加实验名字
            # 跟踪超参数和运行元数据
            config={
                "architecture": "MASAC_IPO_Distribution_reward_cost",
                "name": "MASAC_IPO_Distribution_reward_cost",
                "notes": "MASAC_IPO_Distribution_reward_cost",
            },
        )
        self.episode = -1
        self.timestep = 0
