...
if __name__ == '__main__':
    ...
    print("PPD1_15_violate_count", PPD1_20_violate_count)
    print("PPD2_15_violate_count", PPD2_20_violate_count)
    print("PPD3_15_violate_count", PPD3_20_violate_count)
    print("PPD4_15_violate_count", PPD4_20_violate_count)
    print("PPD5_15_violate_count", PPD5_20_violate_count)
