...
import swanlab  # swanlab是一个实验跟踪工具，类似于Weights and Biases
import time
import os
...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="MATD3",
...
class EnergyPlusEnvironment:
    def __init__(self) -> None:
        ...
        self.swanlab = swanlab.init(
            project="MADDPG-Lag",
            workspace="ZCH_SDU",
            tags=["MADDPG-LAG", "seed=12"],
            experiment_name =  "MADDPG-Lag_seed_12",  # 添加实验名字
            # 跟踪超参数和运行元数据
            config={
                "architecture": "MADDPG-Lag_seed_12",
    ...
    def step(self, action):
        ...
        # else:
        #     occ_indictor = 0
        # occ = [occ_indictor, occ_indictor, occ_indictor, occ_indictor, occ_indictor]
