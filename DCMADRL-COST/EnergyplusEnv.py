...
class EnergyPlusEnvironment:
    def __init__(self) -> None:
        ...
        self.swanlab = swanlab.init(
            project="MASAC_IPO",
            workspace="ZCH_SDU",
            tags=["MASAC", "集中式reward critic", "集中式_分布式_cost critic"],
            experiment_name =  "MASAC_IPO_Distribution_cost_central_critic_central_cost",  # 添加实验名字
            # 跟踪超参数和运行元数据
            config={
                "architecture": "MASAC_IPO_Distribution_cost_central_critic_central_cost",
                "notes": "MASAC_IPO_Distribution_cost_central_critic_central_cost",
            },
        )
        self.episode = -1
        self.timestep = 0
