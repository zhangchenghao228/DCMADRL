...
def get_args():
    ...
    parser.add_argument("--lr-alpha", type=float, default=1e-3, help="learning rate of alpha")
    ...
    # --------------------------------------MASAC--------------------------------------------------------------------
    parser.add_argument("--target_entropy", type=int, default=-2, help="The frequency of policy updates")
    # --------------------------------------MASAC--------------------------------------------------------------------
